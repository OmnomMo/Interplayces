...
public class CreatePredefinedShip : NetworkActions {
    ...
    internal void RpcSetPT(int x, int y, int newID)
    {
        ...
        Debug.Log("Teil + " + newPart.GetComponent<ShipPart>().getID() + " ersetzt Teil " + oldPart.GetComponent<ShipPart>().getID() +" at " + oldPart.GetComponent<ShipPart>().GetPosX()+ "/" + oldPart.GetComponent<ShipPart>().GetPosY());
